...
dependencies {
    ...
    // Depend on the schema-registry-models project
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("Schema Registry Models Test Utils")
                description.set("Test utilities for schema registry model classes")
