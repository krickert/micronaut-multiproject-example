...
/**
 * Utility class for working with the WebCrawlerConfig JSON Schema.
 * This class provides methods to load, validate, and generate configurations
 * based on the JSON Schema.
 */
@Singleton
public class WebCrawlerConfigSchema {

    private static final Logger LOG = LoggerFactory.getLogger(WebCrawlerConfigSchema.class);
    private static final String SCHEMA_PATH = "/schema/web-crawler-config-schema.json";
    
    private final JsonSchema schema;
    private final ObjectMapper objectMapper;

    /**
     * Constructs a new WebCrawlerConfigSchema.
     * Loads the JSON Schema from the resources.
     */
    public WebCrawlerConfigSchema() {
     ...
     */
    public Set<ValidationMessage> validate(WebCrawlerConfig config) {
        try {
     ...
     */
    public boolean isValid(WebCrawlerConfig config) {
