...
/**
 * Utility class for working with the WikipediaConnectorConfig JSON Schema.
 * This class provides methods to load, validate, and generate configurations
 * based on the JSON Schema.
 */
@Singleton
public class WikipediaConnectorConfigSchema {

    private static final Logger LOG = LoggerFactory.getLogger(WikipediaConnectorConfigSchema.class);
    private static final String SCHEMA_PATH = "/schema/wikipedia-connector-config-schema.json";
    
    private final JsonSchema schema;
    private final ObjectMapper objectMapper;

    /**
     * Constructs a new WikipediaConnectorConfigSchema.
     * Loads the JSON Schema from the resources.
     */
    public WikipediaConnectorConfigSchema() {
     ...
     */
    public Set<ValidationMessage> validate(WikipediaConnectorConfig config) {
        try {
     ...
     */
    public boolean isValid(WikipediaConnectorConfig config) {
