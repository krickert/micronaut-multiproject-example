...
class ChunkerServiceGrpcTest {
    ...
    void testProcessData_echoesSuccessfully_blocking() {
        ...
        SemanticProcessingResult semanticResult = SemanticProcessingResult.newBuilder()
                ...
                .setResultSetName("echo-step-1_chunks_default_overlap_500_50")
                .addChunks(chunk)
                .build();
        ...
        PipeDoc outputDoc = PipeDoc.newBuilder()
                ...
                .setCustomData(
                        Struct.newBuilder().putFields("key1", Value.newBuilder().setStringValue("value1").build()).build())
                .setBlob(inputBlob) // Blob is now part of PipeDoc
                .addSemanticResults(semanticResult) // Add the semantic processing result
                .build();
        ...
        assertionTest.assertPipeDocEquals(outputDoc, response.getOutputDoc());
