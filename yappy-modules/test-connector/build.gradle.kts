...
group = "com.krickert.yappy.modules.connector.test"
...
dependencies {
    ...
    implementation(project(":yappy-models:protobuf-models-test-data-resources"))
...
application {
    mainClass = "com.krickert.yappy.modules.connector.test.Application"
}
...
micronaut {
    ...
    processing {
        incremental(true)
        annotations("com.krickert.yappy.modules.connector.test.*")
    }
}