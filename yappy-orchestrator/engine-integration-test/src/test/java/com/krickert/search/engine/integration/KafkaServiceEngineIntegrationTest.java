...
/**
 * Integration test that validates the kafka-service and engine-core integration
    ...
    private PipeStream createTestPipeStream() {
        ...
        return PipeStream.newBuilder()
            ...
            .setDocument(PipeDoc.newBuilder()
                ...
                .setBody("This is a test document for kafka-service and engine-core integration testing.")
                .build())
            .putContextParams("test.source", "kafka-service-engine-integration-test")
