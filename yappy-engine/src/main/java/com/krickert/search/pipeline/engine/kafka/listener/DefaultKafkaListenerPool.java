...
public class DefaultKafkaListenerPool implements KafkaListenerPool {
    ...
    public DynamicKafkaListener createListener(
            ...
            Map<String, String> originalConsumerPropertiesFromStep, // NEW
            String pipelineName,
            String stepName,
        ...
        if (listeners.containsKey(listenerId)) {
            ...
            removeListener(listenerId); // Ensure old one is gone
        }
        ...
        DynamicKafkaListener listener = new DynamicKafkaListener(
                ...
                groupId,
                finalConsumerConfig,
                originalConsumerPropertiesFromStep, // Pass it here
                pipelineName,
                stepName,
                pipeStreamEngine
        );
