...
import com.krickert.search.pipeline.engine.kafka.admin.exceptions.TopicNotFoundException;
import com.krickert.search.pipeline.engine.kafka.admin.model.KafkaTopicStatus;
import com.krickert.search.pipeline.engine.kafka.admin.model.KafkaTopicStatus.ListenerStatus;
...
public class MicronautKafkaTopicStatusService implements KafkaTopicStatusService {
    ...
    private final Map<String, ListenerStatus> listenerStatusCache = new ConcurrentHashMap<>();
    ...
    private KafkaTopicStatus buildTopicStatus(
        ...
        // Get listener status
        ListenerStatus listenerStatus = getListenerStatus(consumerGroupId);
     ...
     */
    private ListenerStatus getListenerStatus(String consumerGroupId) {
        ...
        ListenerStatus status = ListenerStatus.RECEIVING;
