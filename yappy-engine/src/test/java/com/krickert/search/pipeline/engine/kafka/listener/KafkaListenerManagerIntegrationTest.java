package com.krickert.search.pipeline.engine.kafka.listener; // Or your test package

import com.krickert.search.config.consul.DynamicConfigurationManagerImpl;
import com.krickert.search.config.consul.service.ConsulBusinessOperationsService;
import com.krickert.search.config.pipeline.model.*; // Import all your model classes
import com.krickert.search.pipeline.engine.PipeStreamEngine; // For KafkaListenerManager dependency
