...
public class PipeDocExample {
    ...
    public static PipeDoc createFullPipeDoc() {
        ...
        // Set embeddings as a map
        Map<String, Embedding> embeddings = new HashMap<>();
        embeddings.put("embedding1", embedding1);
        embeddings.put("embedding2", embedding2);

        // Use putAllEmbeddings for the embeddings map
        builder.putAllEmbeddings(embeddings);
