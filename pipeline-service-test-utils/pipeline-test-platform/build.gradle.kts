...
dependencies {
    ...
    // Reactive support for Consul watch
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("Pipeline Test Platform")
                description.set("Testing framework for Micronaut and pipeline-core with Kafka and schema registry support")
                url.set("https://github.com/krickert/pipeline-test-platform")
                ...
                scm {
                    connection.set("scm:git:git://github.com/krickert/pipeline-test-platform.git")
                    developerConnection.set("scm:git:ssh://github.com/krickert/pipeline-test-platform.git")
                    url.set("https://github.com/krickert/pipeline-test-platform")
                }
            }
        }
