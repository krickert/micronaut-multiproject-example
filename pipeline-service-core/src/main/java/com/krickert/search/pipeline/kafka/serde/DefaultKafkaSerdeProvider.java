...
public class DefaultKafkaSerdeProvider implements KafkaSerdeProvider {
    ...
    public <K> Deserializer<K> getKeyDeserializer(String pipelineName, PipelineConfig pipelineConfig) {
        KafkaSerdeFactory factory = getFactoryForPipeline(pipelineName, pipelineConfig);
        return factory.getKeyDeserializer(pipelineName, pipelineConfig);
    }
    ...
    public <V> Deserializer<V> getValueDeserializer(String pipelineName, PipelineConfig pipelineConfig) {
        KafkaSerdeFactory factory = getFactoryForPipeline(pipelineName, pipelineConfig);
        return factory.getValueDeserializer(pipelineName, pipelineConfig);
    }
     ...
     */
    private KafkaSerdeFactory getFactoryForPipeline(String pipelineName, PipelineConfig pipelineConfig) {
