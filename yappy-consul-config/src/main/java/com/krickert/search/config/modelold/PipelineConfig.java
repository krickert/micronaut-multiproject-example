...
//
///**
// * PipelineConfig configuration POJO.
...
//                // PipelineConfig exists in Consul, load it
...
//                        LOG.error("PipelineConfig [{}]: Failed to parse kafkaPublishRoutes JSON for step '{}'. Invalid JSON: [{}]. Error: {}",
//                                pipeline.getName(), serviceName, value, e.getMessage());
//                        serviceConfig.setKafkaPublishTopics(Collections.emptyList());
//                    }
//                } else {
//                    serviceConfig.setKafkaPublishTopics(Collections.emptyList());
//                }
